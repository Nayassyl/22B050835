...
background = pygame.image.load("C:\python2\week8\lab\elements\AnimatedStreet.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\python2\week8\lab\elements\coin.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\python2\week8\lab\elements\Enemy.png")
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\python2\week8\lab\elements\Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(p1, coinss):
        pygame.mixer.Sound('C:\python2\week8\lab\elements\coin_collect.wav').play()
        for entity in coinss:
            coin_score += 1
            entity.kill()
        c2 = Coin()
    ...
    if pygame.sprite.spritecollideany(p1, enemies):
        pygame.mixer.Sound('C:\python2\week8\lab\elements\crash.wav').play()
        time.sleep(0.5)
