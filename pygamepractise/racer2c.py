...
background = pygame.image.load("C:\python2\pygamepractise\elements_racer\AnimatedStreet.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\python2\pygamepractise\elements_racer\coin.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\python2\pygamepractise\elements_racer\Enemy.png")
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\python2\pygamepractise\elements_racer\Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    screen.blit(coin_scores, (380, 10))
    ...
    if pygame.sprite.spritecollideany(p1, coinss):
        pygame.mixer.Sound('C:\python2\pygamepractise\elements_racer\mixkit-fairy-arcade-sparkle-866.wav').play()
        for entity in coinss:
            coin_score += 1
            entity.kill()
        c2 = Coin()
    ...
    if pygame.sprite.spritecollideany(p1, enemies):
        pygame.mixer.Sound('C:\python2\pygamepractise\elements_racer\crash.wav').play()
        time.sleep(0.5)
