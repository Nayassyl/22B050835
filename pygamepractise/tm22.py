...
hour_hand = pygame.image.load("C:\python2\pygamepractise\hourhand.png")
...
hour_hand_pos = (WINDOW_SIZE[0] // 2, WINDOW_SIZE[1] // 2)
...
while not exit:
    ...
    hour_angle = (((hour % 12) * 60 + minutes)  / 720)*360
    ...
    hour_hand_rotated = pygame.transform.rotate(hour_hand, 90-hour_angle)
    ...
    hour_hand_pos = (WINDOW_SIZE[0] // 2 - hour_hand_rotated.get_width() // 2,
                       WINDOW_SIZE[1] // 2 - hour_hand_rotated.get_height() // 2)
    ...
    window.blit(hour_hand_rotated, hour_hand_pos)
