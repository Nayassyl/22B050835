...
street = pygame.image.load("C:\python2\week9\lab\elements_racer\street.jpg")
screen.blit(street, (0, 0))

pygame.display.set_caption("Car Racing")
pygame.display.set_icon(pygame.image.load("C:\python2\week9\lab\elements_racer\icon.jpg"))

Oshiheteo = pygame.mixer.Channel(0).play(pygame.mixer.Sound("C:\python2\week9\lab\elements_racer\oshihiteo.mp3"))
clock = pygame.time.Clock()
fps = 60
small = pygame.font.SysFont("", 30)
collection = "C:\python2\week9\lab\elements_racer\collection.mp3"

# Sprites

Player = "C:\python2\week9\lab\elements_racer\Player.png"
Opposite = "C:\python2\week9\lab\elements_racer\Enemy.png"
gold = "C:\python2\week9\lab\elements_racer\golden.webp"
silver = "C:\python2\week9\lab\elements_racer\silver.webp"
bronze = "C:\\python2\\week9\\lab\\elements_racer\\bronze.webp"
...
def game_over():
    ...
    boom = pygame.image.load("C:\\python2\\week9\\lab\\elements_racer\\boom.png")
    gameover = pygame.Surface(screen.get_size())
    gameover.fill(red)
    font = pygame.font.SysFont("", 80)
    text = font.render("GAME OVER", False, black)
    crash_sound = pygame.mixer.Sound("C:\python2\week9\lab\elements_racer\crash.wav")
