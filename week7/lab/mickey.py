...
mickey = pygame.image.load("C:\python2\week7\lab\main-clock.png")



minute_hand = pygame.image.load("C:\\python2\\week7\\lab\\righthand.png")
second_hand = pygame.image.load("C:\python2\week7\lab\lefthand.png")
